...
if($action == 'modifica'){
    switch ($area) {
        case 'circuiti':
            echo "<p>Inserisci l'id del circuito da modificare</p>";
            echo '
            <form class="admin-form">
                <label for="id_circuito">ID</label>
                <input type="text" name="id_circuito">
        ...
        case 'gare':
            ...
            break;
        case 'piloti':
            echo "<p>Inserisci l'id del pilota da modificare</p>";
            echo '
            <form class="admin-form">
                <label for="id">ID</label>
                <input type="text" name="id" required>
            ...
            break;
        case 'scuderie':
            echo "<p>Inserisci il nome della scuderia da modificare</p>";
            echo '
            <form class="admin-form">
                <label for="nome">Nome</label>
                <input type="text" name="nome" required>
...
if($action == 'elimina'){
    switch ($area) {
        case 'circuiti':
            echo "<p>Inserisci l'id del circuito da eliminare</p>";
            echo '
            <form class="admin-form">
                <label for="id_circuito">ID</label>
                <input type="text" name="id_circuito">
        ...
        case 'gare':
            ...
            break;
        case 'piloti':
            echo "<p>Inserisci l'id del pilota da eliminare</p>";
            echo '
            <form class="admin-form">
                <label for="id">ID</label>
                <input type="text" name="id" required>
            ...
            break;
        case 'scuderie':
            echo "<p>Inserisci il nome della scuderia da eliminare</p>";
            echo '
            <form class="admin-form">
                <label for="nome">Nome</label>
                <input type="text" name="nome" required>
