...
\begin{itemize}
    ...
    \item \textbf{Browser diversi}: sono stati effettuati test di navigazione su diversi browser (Chrome, Firefox, Edge) per verificare la compatibilità e l'usabilità del sito su diverse piattaforme;
